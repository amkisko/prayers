...
- Publish the new package and engineering-audit 2.7.2 only after review.
- Consumers can tree `amkisko/operational-signal-intake` and map its source roles to their available services in project-specific context.
